...
var addExercises = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(exercises.map(function (exercise) {
                        // validate translatedLiterallyFrom
                        if (exercise.translation.split(' ').length !==
                            exercise.translatedLiterallyFrom.split(' ').length) {
                            throw new Error('translatedLiterallyFrom and translation must have same number of words');
                        }
                        ...
                        // validate match.translation
                        if (!exercise.options
                            .map(function (option) { return option.toLowerCase(); })
                            .includes(exercise.match.translation.toLowerCase())) {
